...
export const mockCaseOverview: CaseOverviewItem[] = [
  {
    label: '申请人',
    value: '北京科技有限公司。主张其已依约完成货物交付，被申请人长期拖欠货款及违约金。',
    tone: 'neutral'
  },
  {
    label: '被申请人',
    value: '上海贸易有限公司。现有材料显示其为合同相对方，但最新工商登记信息尚未补齐。',
    tone: 'neutral'
  },
  {
    label: '仲裁依据',
    value: '双方于 2023 年 12 月签订购销合同，合同第 12 条约定因履行争议提交北京仲裁委员会仲裁。',
    tone: 'neutral'
  },
  {
    label: '案情经过',
    value: '申请人称已于 2023-12-08 完成首批交付。被申请人于验收后未按约支付货款，申请人经对账、催告后仍未获清偿，故申请仲裁，要求支付货款、违约金及相关利息。',
    tone: 'warning',
    span: 'full'
  }
];
